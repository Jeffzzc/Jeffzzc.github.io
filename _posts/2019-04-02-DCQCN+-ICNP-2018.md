...
- ***Hyper Increase*** is triggered when both the states exceed $F$. In ***Hyper Increase***, the rate shows an exponential growth with parameter RHAI, $i = min\{{time\_state}, {byte\_state}\} − F$: 
