...
<img width="420" height="450" src="/img/post-swift-3.png"/>
...
<img width="320" height="200" src="/img/post-swift-6.png"/>
 
<img width="420" height="450" src="/img/post-swift-7.png"/>
...
- 区分fabric congestion 和 endpoint congestion, 这个思想在之前的拥塞控制协议中没有强调, 主要是因为仍然认为fabric congestion是拥塞的主要种类, fabric 的 congestion 对性能影响最大；但是随着网络带宽增加, 应用需求增高, endpoint congestion越来越不容忽视; 区分这两类拥塞也能更好地进行异常定位;
