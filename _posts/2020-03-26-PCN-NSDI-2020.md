...
**拓扑**：拓扑的构造看似简单，本质上是CLOS网络单元的高度抽象，很多早期的拥塞控制论文构造的也是类似拓扑。
<img width="550" height="350" src="/img/post-pcn-4.png"/>

**流量**：实验的流量是长短流混合，其实是作者精巧设计的。



<img width="550" height="350" src="/img/post-pcn-3.png"/>
