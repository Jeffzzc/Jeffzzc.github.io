...
<img width="450" height="450" src="/img/post-loss-3.png"/>
...
<img width="450" height="450" src="/img/post-loss-4.png"/>

digest里还可以包含其他信息：默认包括五元组，IP_ID(用于标识数据包). 其他flag信息等也可以

measurement batch：每隔$T$时间将digest信息上传. 每个数据包携带一个batch_ID区分batch. 为了应对数据包存在乱序，下游的meter $T + timeout$
...
<img width="450" height="450" src="/img/post-loss-5.png"/>
...
<img width="450" height="450" src="/img/post-loss-6.png"/>
...
1. **Root cause analyzer**
   ...
   <img width="350" height="650" src="/img/post-loss-7.png"/>
